...
export default function GTTask2Page() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f4f1e9", fontFamily: "'Helvetica Neue', Arial, sans-serif", color: "#1b2420" }}>
      <header style={{ borderBottom: "3px double #1b2420", padding: "28px 24px 18px", textAlign: "center" }}>
        <div style={{ fontFamily: "'Courier New', monospace", letterSpacing: "0.22em", fontSize: 11, textTransform: "uppercase", color: "#a8472e", marginBottom: 8 }}>General Training · Task 2</div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "30px 20px 70px" }}>
        <div style={{ background: "#fffdf7", border: "1px solid #cfc8b4", boxShadow: "0 6px 18px rgba(0,0,0,0.05)" }}>
          ...
          <div style={{ padding: "12px 20px 0 26px" }}>
            ...
            <input value={prompt} onChange={e => setPrompt(e.target.value)} placeholder="e.g. Some people think the government should provide free public transport..." style={{ width: "100%", border: "none", borderBottom: "1px dashed #cfc8b4", background: "transparent", fontSize: 12.5, padding: "6px 2px", color: "#5a5440", outline: "none", boxSizing: "border-box" }} />
          </div>
