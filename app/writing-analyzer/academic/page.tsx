  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f4f1e9", fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      <header style={{ borderBottom: "3px double #1b2420", padding: "28px 24px 18px", textAlign: "center" }}>
        <div style={{ fontFamily: "'Courier New', monospace", letterSpacing: "0.22em", fontSize: 11, textTransform: "uppercase", color: "#3c5e4e", marginBottom: 8 }}>
          Academic
        </div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "60px 20px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
          <Link href="/writing-analyzer/academic/task1" style={{ textDecoration: "none" }}>
            <div style={{ background: "#fffdf7", border: "1px solid #cfc8b4", padding: "36px 24px", textAlign: "center", boxShadow: "0 6px 18px rgba(0,0,0,0.05)", cursor: "pointer" }}>
              ...
              <h2 style={{ fontFamily: "Georgia, serif", fontSize: 20, color: "#1b2420", margin: "0 0 6px" }}>Task 1 — Report</h2>
              <p style={{ fontFamily: "'Courier New', monospace", fontSize: 11, color: "#7a7259", margin: 0 }}>20 MIN · 150 WORDS MIN</p>
              <p style={{ fontFamily: "Georgia, serif", fontSize: 11, color: "#7a7259", margin: "6px 0 0", fontStyle: "italic" }}>Graph, chart, table, diagram or process</p>
              <div style={{ marginTop: 18, fontFamily: "'Courier New', monospace", fontSize: 12, color: "#3c5e4e", textTransform: "uppercase" }}>Start →</div>
            </div>
          </Link>

          <Link href="/writing-analyzer/academic/task2" style={{ textDecoration: "none" }}>
            <div style={{ background: "#fffdf7", border: "1px solid #cfc8b4", padding: "36px 24px", textAlign: "center", boxShadow: "0 6px 18px rgba(0,0,0,0.05)", cursor: "pointer" }}>
              <div style={{ fontSize: 36, marginBottom: 14 }}>📝</div>
